...
colors = [["#282828", "#282828"], # panel background
          ["#242424", "#242424"], # background for current screen tab
          ["#000000", "#000000"], # font color for group names
          ["#242424", "#242424"], # border line color for current tab
          ["#666666", "#666666"], # border line color for 'other tabs' and color for 'odd widgets'
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=1, margin=[5,30,1,20], size=23)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), opacity=1, margin=[5,30,1,20], size=23)),
            Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=1, margin=[5,30,1,20], size=23))]
